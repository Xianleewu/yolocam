...
set(PROJECT_HOST_DIR "/home/xianlee/workspace/rk3588_ipc")
set(RELOCATED_HOST_DIR "/home/xianlee/workspace/rk3588_ipc/tools/linux/toolchain/aarch64-rockchip1031-linux-gnu")

message("=============")
message(${CMAKE_CURRENT_LIST_DIR})
message(${RELOCATED_HOST_DIR})
message("=============")
...
set(CMAKE_FIND_ROOT_PATH "${RELOCATED_HOST_DIR}/aarch64-none-linux-gnu")
set(CMAKE_FIND_ROOT_PATH_MODE_PROGRAM NEVER)
set(CMAKE_FIND_ROOT_PATH_MODE_PACKAGE ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_LIBRARY ONLY)
set(CMAKE_FIND_ROOT_PATH_MODE_INCLUDE ONLY)
set(ENV{PKG_CONFIG_SYSROOT_DIR} "${RELOCATED_HOST_DIR}/aarch64-none-linux-gnu")
...
set(CMAKE_AR "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-ar")
set(CMAKE_AS "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-as")
set(CMAKE_LINKER "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-ld")
set(CMAKE_NM "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-nm")
set(CMAKE_RANLIB "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-ranlib")
set(CMAKE_READELF "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-readelf")
set(CMAKE_STRIP "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-strip")
set(CMAKE_OBJCOPY "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-objcopy")
set(CMAKE_OBJDUMP "${RELOCATED_HOST_DIR}/bin/aarch64-none-linux-gnu-objdump")

link_directories(${PROJECT_HOST_DIR}/media/libdrm/out)
include_directories(${PROJECT_HOST_DIR}/media/libdrm/include)
